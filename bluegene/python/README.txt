...
#
# The posix module is required.  To get the posix module to compile you may need
# to edit the CMakeCache.txt in the build folder and set HAVE_GETGROUPS and
# HAVE_SETGROUPS to 0.  The check-symbol-exists seems to fail for these.
#
